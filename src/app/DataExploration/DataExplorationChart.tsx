...
const DataExplorationChart: React.FC<DataExplorationChartProps> = ({ data, columns, datetimeColumn }) => {
    ...
    return (
        <Paper elevation={2} sx={{ borderRadius: 4, display: 'flex', flexDirection: 'column', gap: 2, p: 2 }}>
    ...
    />
    <Button variant="text" onClick={handleReset} sx={{ ml: 2 }} size="small"
    >
                    Reset View
    </Button>
            </Box>
                
            <VegaLite spec={spec} style={{ width: "100%" }} />
        </Paper>
    );
};
